...
#define ITP_IOCTL_SET_BAUDRATE         76  ///< SWUart codec set baudrate
#define ITP_IOCTL_SET_PARITY           77  ///<SWUart codec set parity
 ...
 * @code
    ...
    if (itpTaskVcdGetEventIndex() == 8192)
        itpTaskVcdWrite();
