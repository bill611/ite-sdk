...
typedef enum
{
    ...
    ITH_GPIO_MODE_TX0      = 4,  ///< mode for UART TX 0
    ITH_GPIO_MODE_RX0      = 5,  ///< mode for UART RX 0
    ITH_GPIO_MODE_TX1      = 6,  ///< mode for UART TX 1
    ITH_GPIO_MODE_RX1      = 7,  ///< mode for UART RX 1
    ITH_GPIO_MODE_TX2      = 8,  ///< mode for UART TX 2
    ITH_GPIO_MODE_RX2      = 9,  ///< mode for UART RX 2 from GPIO
    ITH_GPIO_MODE_RX2WGAND = 10, ///< mode for UART RX 2 from Wiegand
    ITH_GPIO_MODE_TX3      = 11, ///< mode for UART TX 3
    ITH_GPIO_MODE_RX3      = 12, ///< mode for UART RX 3  from GPIO
    ITH_GPIO_MODE_RX3WGAND = 13  ///< mode for UART RX 3 from Wiegand
} ITHGpioMode;
