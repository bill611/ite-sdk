 ...
 * @param cloned Retrieved sprite button widget.
 * @return true if clone is success, false otherwise.
 */
 ...
 *  @{
 */
#define ITU_WHEEL_CYCLE_ARR_LIMIT 64
...
// xb add 20161209
void ituTextBoxShowCursor(ITUTextBox *);
void ituTextBoxHideCursor(ITUTextBox *);
#ifdef __cplusplus
}
#endif
