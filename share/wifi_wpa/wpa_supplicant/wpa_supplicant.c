...
#if 1	
	global->params.wpa_debug_level = params->wpa_debug_level = wpa_debug_level;
	global->params.wpa_debug_show_keys = params->wpa_debug_show_keys = wpa_debug_show_keys;
	global->params.wpa_debug_timestamp = params->wpa_debug_timestamp = wpa_debug_timestamp;
#endif
