...
static int nor_readmultiplesector(F_DRIVER *driver,void *data, unsigned long sector, int cnt)
{
	if ( norCache )
	{
...
static int nor_writemultiplesector(F_DRIVER *driver,void *data, unsigned long sector, int cnt)
{
    if ( norCache )
	{
