...
#else // new touch
#define CTP_CFG_GROUP	{\
0x44,0x00,0x04,0x58,0x02,0x05,0x3C,0x00,0x01,0x10,\
0x28,0x0A,0x50,0x32,0x03,0x05,0x00,0x00,0x00,0x00,\
0x00,0x00,0x04,0x18,0x1A,0x1E,0x14,0x8C,0x2E,0x0E,\
0x2D,0x2B,0xB5,0x06,0x00,0x00,0x00,0x02,0x02,0x1C,\
0x00,0x05,0x00,0x00,0x00,0x03,0x64,0x32,0x00,0x00,\
0x00,0x1E,0x46,0x94,0xC5,0x02,0x07,0x00,0x00,0x04,\
0xAA,0x20,0x00,0x90,0x26,0x00,0x7A,0x2D,0x00,0x67,\
0x36,0x00,0x58,0x40,0x00,0x58,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x1C,0x1A,0x18,0x16,0x14,0x12,0x10,0x0E,\
...
static void _tpInitSpec_vendor(void)
{
	...
	gTpSpec.tpCvtReverseY      = (char)1;                    //from Kconfig setting
...
void _tpResetPin()
{
	_tpGpioOutPut(gTpSpec.tpIntPin, 0);
	mdelay(10);                         // T2: > 10ms
	...
	mdelay(50);                          // T4: > 5ms
	_tpGpioOutPut(gTpSpec.tpIntPin, 1);
 ...
 */
static int icn81xxread(struct tslib_module_info *inf, struct ts_sample *samp, int nr)
{
...
static const struct tslib_ops icn81xxops =
{
	icn81xxread,
};
