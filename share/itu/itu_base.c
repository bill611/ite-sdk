...
static void FtDrawTextDefault(ITUSurface* surf, int x, int y, const char* text)
{
    // DO NOTHING
}
void (*ituFtDrawText)(ITUSurface* surf, int x, int y, const char* text) = FtDrawTextDefault;
...
void (*ituTransformBlt)(ITUSurface* dest, int dx, int dy, ITUSurface* src, int sx, int sy, int sw, int sh, int x0, int y0, int x1, int y1, int x2, int y2, int x3, int y3, bool bInverse, ITUPageFlowType type) = TransformBltDefault;
