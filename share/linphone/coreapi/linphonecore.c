...
*/
    #ifdef CFG_MP3_RING
        tmpbuf=lp_config_get_string(lc->config,SOUND,"source_local",LOCAL_RING);       
    #else
    ...
    #ifdef CFG_MP3_RING
        tmpbuf=lp_config_get_string(lc->config,SOUND,"source_remote",REMOTE_RING);       
    #else
...
// if select all in kconfig, the priority is speex > a-law > u-law
// if select none, the default is speex
