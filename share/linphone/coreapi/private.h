...
struct _LinphoneCallParams{
    ...
    bool_t pad;
	bool_t call_mobile; /*call to mobile phone*/
    bool_t video_from_ipcam;
    bool_t play_video_msg;
    bool_t refer_received;
};
...
struct _LinphoneCore
{
    ...
    struct _PlayRecstream *play_rec_stream;
#endif
    bool_t isVideoMemoPlaying;
    bool_t b_DoNotDisturb;
    bool_t isMuteWhenDoNotDisturb;
    bool_t isSpecialCaseForTerminate;
    char *ipcam_address;
    bool_t isVideoFromIPCam;
    bool_t isIPCamWatching;
    bool_t isADVPlaying;
    bool_t isMediaVideoPlaying;
    bool_t isMediaAudioPlaying;
    struct _VideoStream *ipcamstream;
};
