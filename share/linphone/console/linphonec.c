...
static void linphonec_call_state_changed(LinphoneCore *lc, LinphoneCall *call, LinphoneCallState st, const char *msg){
    ...
    switch(st){
        ...
        case LinphoneCallIncomingReceived:
			...
			buf = GetMulticastGroup_from_AddressBook(strtok_r(NULL, ">", &saveptr));
			if(buf)
			{
...
static void castor3_init_call_logs(LinphoneCore *lc)
{
    ...
    for (elem=lc->call_logs; elem!=NULL; elem=ms_list_next(elem))
    {
...
linphonec_init(int argc, char **argv)
{
    ...
    strcpy(configfile_name,"d:/linphonerc");
    strcpy(zrtpsecrets,"d:/linphone-zidcache");
    #else
