...
int ithCapControllerSetBT656(uint16_t capwidth,uint16_t capheight,CAP_INPUT_DATA_FORMAT input_dFmt)
{
    ...
    Capctxt->ininfo.HSyncPol    = 0;
    Capctxt->ininfo.VSyncPol    = 0;
    Capctxt->ininfo.TopFieldPol = MMP_TRUE; // fingerprint will set it false.
    ...
    Capctxt->ininfo.HNum1       = 0;//264 + 18;
    Capctxt->ininfo.HNum2       = 0;//1703 + 18;
    Capctxt->ininfo.LineNum1    = 0;//23 - 4;
    Capctxt->ininfo.LineNum2    = 0;//310 - 4;
    Capctxt->ininfo.LineNum3    = 0;//336 - 4;
    Capctxt->ininfo.LineNum4    = 0;//623 - 4;
