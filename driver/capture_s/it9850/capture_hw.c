    ...
    void)
{
    ...
    //ithWriteRegMaskH(ITH_SENSOR_CLK_REG, 0x02 << 8 , ITH_SENSOR_CLK_SEL_MASK); //24.2Mhz
    //ithWriteRegMaskH(ITH_SENSOR_CLK_REG, 0x0A, ITH_SENSOR_CLK_RATIO_MASK);  //24.2Mhz //from PLL2Out1 

	ithWriteRegMaskH(ITH_SENSOR_CLK_REG, 0x00 << 8 , ITH_SENSOR_CLK_SEL_MASK); //24.2Mhz
    ithWriteRegMaskH(ITH_SENSOR_CLK_REG, 0x0F, ITH_SENSOR_CLK_RATIO_MASK);  //24.2Mhz //from PLL2Out1 
