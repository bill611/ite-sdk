 ...
 */
/** @file
 * Used as Gigabit Ethernet Controller Register Definition.
 *
 * @author Irene Lin
 * @version 1.0
 */
...
// Irene: TODO
#define MAC_REF_CLK_DELAY(x)        (((x) & 0xff) << 20)
#define MAC_REF_CLK_INVERT          (1 << 28)
#define MAC_REF_CLK_FROM_PHY        (1 << 29)
#define AHBReg_Little_Edn           (1 << 30)
#define AHB_Little_Edn              (1 << 31)
