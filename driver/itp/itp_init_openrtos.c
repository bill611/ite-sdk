...
void itpInit(void)
{
    ...
    ioctl(ITP_DEVICE_RS485_0, ITP_IOCTL_RESET, ITH_UART_NONE);
#endif
	...
	ioctl(ITP_DEVICE_RS485_1, ITP_IOCTL_RESET, ITH_UART_NONE);
#endif
    ...
    ioctl(ITP_DEVICE_RS485_2, ITP_IOCTL_RESET, ITH_UART_NONE);
#endif
    ...
    ioctl(ITP_DEVICE_RS485_3, ITP_IOCTL_RESET, ITH_UART_NONE);
#endif
